...
const main = async () => {
  const cars = [
    ...
    {
      imgURL: [
        "https://i.imgur.com/1fKboPc.jpg",
      ],
      year: "1959",
      make: "Cheverlot",
      model: "Bel Air",
      description: " A two-door hard top sedan version of the 1959 Chevrolet. It was available in three series models: the upscale Bel Air, the mid-range Two-Ten, and the One-Fifty. A two-door station wagon, the Nomad, was produced as a Bel Air model.“,
      ,
      price: "120,000",
      vin: "--",
      mileage: "65,000",
...
,
    ...
    {
      imgURL: "https://images.unsplash.com/photo-1554697713-4e7256fbc82e?ixid=MXwxMjA3fDB8MHxwaG90by1[…]ufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
      year: '1927',
      make: 'Ford',
      model: 'Model T',
    ...
    {
      imgURL: ["https://images.unsplash.com/photo-1594055218605-87dfde0777e5?ixid=MXwxMjA3fDB8MHxwaG90[…]ufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=2434&q=80", "https://images.unsplash.com/photo-1594055227781-acac5da4764d?ixid=MXwxMjA3fDB8MHxwaG90[…]VufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=668&q=80", "https://images.unsplash.com/photo-1594055232666-262e338bb407?ixlib=rb-1.2.1&ixid=MXwxM[…]0by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=668&q=80"
        ],
        year: "1969",
        make: "Cheverlot",
        model: "Camaro SS",
